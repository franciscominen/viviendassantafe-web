...
const TabsModels = () => {
    return (
        <>  
            <Tabs>
                <TabList>
                    <Tab _selected={{ color:'white', background: "#009D3C" }} color='#003B71' background='none'>Modelo 3062</Tab>
                    ...
                    <TabPanel>
                        ...
                        <section className='tab-panel'>
                            <div className='descript-container'>
                                <h2><span>Mod</span>elo 3062</h2>
                                <p>Este modelo cuenta con una superficie total de 6 x 6 metros,
                                2 dormitorios de 3 x 3 metros, un baño y cocina con comedor.</p>
                            </div>
                    ...
                    <TabPanel>
                        ...
                        <section className='tab-panel'>
                            <div className='descript-container'>
                                ...
                                2 dormitorios de 3 x 3 metros, un baño, cocina y estar-comedor.</p>
                            </div>

                            <img src={"/assets/img/models/4702.png"} style={{maxWidth:'280px'}}/>
                    ...
                    <TabPanel>
                        ...
                        <section className='tab-panel'>
                            <div className='descript-container'>
                                ...
                                <p>Nuestro modelo premium, con una superficie total de 10,8 x 6 metros, dos baños, uno en suite, dos dormitorios, cocina, lavadero, estar-comedor y living.</p>
                            </div>

                            <img src={"/assets/img/models/6503.png"} style={{maxWidth:'225px'}}/>
